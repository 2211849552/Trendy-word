    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5 px-5 py-6">
          <div>
            <label htmlFor="cat-name" className="mb-1.5 block text-sm font-semibold text-slate-800">
          ...
          <div>
            ...
            <p className="mb-2 text-xs text-slate-500">S، M، L، XL — اختر ما ينطبق على هذا التصنيف</p>
