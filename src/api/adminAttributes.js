...
export function getAdminAttributes(params = {}) {
  ...
  return apiRequest(`/api/v1/admin/attributes${query ? `?${query}` : ''}`)
}

// POST /api/v1/admin/attributes
export function createAdminAttribute(body) {
  return apiRequest('/api/v1/admin/attributes', {
    method: 'POST',
    body: JSON.stringify(body),
  })
}

// GET /api/v1/admin/attributes/{attribute}
export function getAdminAttribute(attribute) {
  return apiRequest(`/api/v1/admin/attributes/${attribute}`)
}

// PUT /api/v1/admin/attributes/{attribute}
...
// DELETE /api/v1/admin/attributes/{attribute}
